...
```{r}
project <- "surv-727-295117"
```

We will begin with interacting with the BigQuery sample tables using the `DBI` package, with `bigrquery` as a backend. We set up the connection to the database as outlined here:
